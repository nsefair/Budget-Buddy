...
export const ENDPOINTS = {
  ...
  BUDGET: {
    ...
    APPLY_SUGGESTIONS: "/budget/suggestions/apply",
  ...
  GOALS: {
    ...
    CONTRIBUTE: (id: string) => `/goals/${id}/contribution`,
  ...
  BUDS: {
	...
	SHAREABLE_ACHIEVEMENTS: "/buds/shareable-achievements",
    MY_BUDS: "/buds/following",
    FOLLOWERS: "/buds/followers",
    POST: "/buds/posts",
	MEDIA: "/buds/media",
	COMMENTS: (postId: string) => `/buds/posts/${postId}/comments`,
